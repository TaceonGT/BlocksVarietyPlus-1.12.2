...
import com.ridebuilder5.blocksvarietyplus.items.tools.ToolHammer;
...
public static final List<Item> ITEMS = new ArrayList<Item>();
	...
	public static final ItemHatchet OAK_HATCHET = new ToolHatchet("oak_hatchet", ToolMaterial.WOOD);
	public static final ItemHatchet SPRUCE_HATCHET = new ToolHatchet("spruce_hatchet", ToolMaterial.WOOD);
	public static final ItemHatchet BIRCH_HATCHET = new ToolHatchet("birch_hatchet", ToolMaterial.WOOD);
	public static final ItemHatchet JUNGLE_HATCHET = new ToolHatchet("jungle_hatchet", ToolMaterial.WOOD);
	public static final ItemHatchet ACACIA_HATCHET = new ToolHatchet("acacia_hatchet", ToolMaterial.WOOD);
	public static final ItemHatchet DARK_OAK_HATCHET = new ToolHatchet("dark_oak_hatchet", ToolMaterial.WOOD);
	public static final ItemHatchet ELM_HATCHET = new ToolHatchet("elm_hatchet", MATERIAL_ELM);
	public static final ItemHatchet CHERRY_HATCHET = new ToolHatchet("cherry_hatchet", MATERIAL_CHERRY);
	...
	public static final ItemHammer STONE_HAMMER = new ToolHammer("stone_hammer", ToolMaterial.STONE);
	public static final ItemHammer GRANITE_HAMMER = new ToolHammer("granite_hammer", MATERIAL_GAD);
	public static final ItemHammer ANDESITE_HAMMER = new ToolHammer("andesite_hammer", MATERIAL_GAD);
	public static final ItemHammer DIORITE_HAMMER = new ToolHammer("diorite_hammer", MATERIAL_GAD);
	public static final ItemHammer MARBLE_HAMMER = new ToolHammer("marble_hammer", MATERIAL_MARBLE);
